...
function TrendingRecipes() {
  ...
  const data = useStaticQuery(graphql`
    query {
      first: recipes(slug: { eq: "paneer-thread-rolls-recipe" }) {
        title
        thumbnail
        slug
        description
      ...
      second: recipes(slug: { eq: "chocolate-chip-cookies-recipe" }) {
        title
        thumbnail
        slug
        description
      ...
      third: recipes(slug: { eq: "fried-cheese-cubes-recipe" }) {
        title
        thumbnail
        slug
        description
